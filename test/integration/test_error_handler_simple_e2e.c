...
static void custom_error_handler(uvhttp_error_t error, const char* message, void* user_data) {
...
static int success_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int trigger_400_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int trigger_401_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int trigger_403_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int trigger_500_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int error_stats_handler(uvhttp_request_t* request, uvhttp_response_t* response) {
...
static int send_http_request(const char* method, const char* path, char* response, size_t max_len) {
    char cmd[512];
    snprintf(cmd, sizeof(cmd), "curl -s -w '\\n%%{http_code}' -X %s http://127.0.0.1:8779%s 2>/dev/null", method, path);
