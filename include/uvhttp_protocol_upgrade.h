 ...
 * 
 * This function is used to detect if an HTTP request matches a specific protocol.
 * 
...
typedef struct {
    ...
    void (*on_close)(void* user_data); /**< Callback function when connection is closed */
