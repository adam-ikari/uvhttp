...
const patterns = [
    ...
    { regex: /ifwithoutmatch route，check回退路由/g, replacement: 'if no matching route, check fallback route' },
    ...
    { regex: /new条目，needremove from hash table并free/g, replacement: 'new entry, need remove from hash table and free' },
    { regex: /从LRU链table中remove/g, replacement: 'remove from LRU linked list' },
