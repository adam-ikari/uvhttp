...
int main() {
    ...
    // 运行所有测试
    TEST_UtilsTest_SafeStrncpy();
    TEST_UtilsTest_ValidateUrl();
    TEST_UtilsTest_ValidateHeaderValue();
    TEST_UtilsTest_ValidateMethod();
    TEST_UtilsTest_EdgeCases();
    TEST_UtilsTest_PerformanceBoundaries();
    TEST_UtilsTest_ErrorRecovery();
    TEST_UtilsTest_ThreadSafety();
