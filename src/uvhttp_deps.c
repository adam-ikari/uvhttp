...
uvhttp_loop_provider_t* uvhttp_default_loop_provider_new(void) {
    uvhttp_loop_provider_t* provider = uvhttp_alloc(sizeof(uvhttp_loop_provider_t));
...
uvhttp_memory_provider_t* uvhttp_default_memory_provider_new(void) {
    uvhttp_memory_provider_t* provider = uvhttp_alloc(sizeof(uvhttp_memory_provider_t));
    if (!provider) return NULL;
...
uvhttp_network_provider_t* uvhttp_default_network_provider_new(void) {
    uvhttp_network_provider_t* provider = uvhttp_alloc(sizeof(uvhttp_network_provider_t));
    if (!provider) return NULL;
...
uvhttp_file_provider_t* uvhttp_default_file_provider_new(void) {
    uvhttp_file_provider_t* provider = uvhttp_alloc(sizeof(uvhttp_file_provider_t));
    if (!provider) return NULL;
...
uvhttp_memory_provider_t* uvhttp_test_memory_provider_new(void) {
    test_memory_data_t* data = uvhttp_alloc(sizeof(test_memory_data_t));
    if (!data) return NULL;
...
uvhttp_network_provider_t* uvhttp_test_network_provider_new(void) {
    test_network_data_t* data = uvhttp_alloc(sizeof(test_network_data_t));
    if (!data) return NULL;
...
uvhttp_file_provider_t* uvhttp_test_file_provider_new(void) {
    test_file_data_t* data = uvhttp_alloc(sizeof(test_file_data_t));
    if (!data) return NULL;
...
uvhttp_deps_t* uvhttp_deps_new(void) {
    uvhttp_deps_t* deps = uvhttp_alloc(sizeof(uvhttp_deps_t));
    if (!deps) return NULL;
