...
uvhttp_error_t uvhttp_get_build_info_json(char** json_str) {
    ...
    size_t buffer_size = 4096; /* Base size */
    ...
    int len = snprintf(buffer, buffer_size,
        ...
        info.compiler,
        info.platform,
        info.feature_websocket ? "true" : "false",
        info.feature_static_files ? "true" : "false",
        info.feature_tls ? "true" : "false",
        info.feature_middleware ? "true" : "false",
        info.feature_logging ? "true" : "false",
        info.feature_router_cache ? "true" : "false",
        info.feature_lru_cache ? "true" : "false",
        info.feature_cors ? "true" : "false",
        info.feature_rate_limit ? "true" : "false",
        info.feature_protocol_upgrade ? "true" : "false",
        info.allocator_type,
        info.allocator_enabled ? "true" : "false",
        info.max_connections,
        info.max_headers,
        info.max_body_size,
        info.buffer_size,
        ...
        info.lru_cache_size,
        info.lru_cache_max_memory,
        info.tls_enabled ? "true" : "false",
        info.tls_version ? info.tls_version : "null");
