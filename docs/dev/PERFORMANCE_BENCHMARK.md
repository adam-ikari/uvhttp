...
| 指标 | 平均值 | 最小值 | 最大值 | 标准差 |
|-----|-------|-------|-------|-------|
| 吞吐量 (RPS) | **17,798** | 17,339.71 | 18,211.96 | 346.52 |
| 平均延迟 | 518 μs | 502.24 μs | 529.78 μs | 10.87 μs |

#### 中等并发场景（4 线程 / 50 连接）

| 指标 | 平均值 | 最小值 | 最大值 | 标准差 |
|-----|-------|-------|-------|-------|
| 吞吐量 (RPS) | **17,209** | 16,327.03 | 17,715.28 | 485.39 |
| 平均延迟 | 2.79 ms | 2.68 ms | 2.89 ms | 0.10 ms |

#### 高并发场景（8 线程 / 200 连接）

| 指标 | 平均值 | 最小值 | 最大值 | 标准差 |
|-----|-------|-------|-------|-------|
| 吞吐量 (RPS) | **16,623** | 15,563.12 | 17,024.38 | 548.57 |
| 平均延迟 | 12.20 ms | 11.85 ms | 13.07 ms | 0.58 ms |

#### 性能总结

| 测试场景 | RPS | 平均延迟 | 传输速率 | 状态 |
|---------|-----|---------|---------|------|
| 低并发 | **17,798** | 518 μs | 1.75MB/s | ✅ |
| 中等并发 | **17,209** | 2.79 ms | 1.70MB/s | ✅ |
| 高并发 | **16,623** | 12.20 ms | 1.66MB/s | ✅ |
