...
UVHTTP 是基于 libuv 的 HTTP/1.1 和 WebSocket 服务器库，C99 编写。本规范定义项目开发中的工程标准。
...
- **标准版本**：C99
- **最低要求**：支持 C99 的编译器（GCC 4.8+, Clang 3.3+）
- **编译器要求**：
  ```cmake
...
UVHTTP 项目在开发过程中需要使用多种技术栈。本规范定义技术栈选择的原则、标准和实践。
